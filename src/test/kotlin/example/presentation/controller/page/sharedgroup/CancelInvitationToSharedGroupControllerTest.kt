...
@ControllerTest
internal class CancelInvitationToSharedGroupControllerTest(@Autowired private val mockMvc: MockMvc,
    ...
    @DisplayName("共有グループへの招待のキャンセルに成功した場合、共有グループ管理画面にリダイレクトする")
