...
object TestMedicationRecordEditCommandFactory {
    fun createCompletedAdditionCommand(takenMedicine: String = "testMedicineId",
        ...
        return MedicationRecordEditCommand(takenMedicine, quantity, symptom, beforeTaking, afterTaking, note, takenAt)
    }

    fun createCompletedModificationCommand(takenMedicine: String = "testMedicineId",
                                           quantity: Double? = 2.0,
                                           symptom: String = "頭痛",
                                           beforeTaking: ConditionLevel = example.domain.model.medicationrecord.ConditionLevel.A_LITTLE_BAD,
