...
internal class MyBatisTakingRecordQueryServiceTest(@Autowired private val takingRecordQueryService: TakingRecordQueryService,
    ...
    fun getTakingRecords() {
        ...
        val expectedDisplayTakingRecord = createDisplayTakingRecord(member, sharedGroupMedicine, memberTakingRecord)
    ...
    fun createDisplayTakingRecord(profile: Profile,
                                  medicine: Medicine,
                                  takingRecord: TakingRecord): DisplayTakingRecord {
        return DisplayTakingRecord(takingRecord.id,
