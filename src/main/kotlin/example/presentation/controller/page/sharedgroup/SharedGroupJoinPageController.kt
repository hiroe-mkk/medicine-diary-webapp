...
class SharedGroupJoinPageController(private val sharedGroupService: SharedGroupService,
    ...
    fun displaySharedGroupJoinPage(code: String, model: Model): String {
        ...
        val joinedSharedGroupId = sharedGroupService.getJoinedSharedGroup(userSession)
        model.addAttribute("joinedSharedGroupId", joinedSharedGroupId)

        try {
            val invitedSharedGroupId = sharedGroupService.getJoinableInvitedSharedGroupId(code, userSession)
